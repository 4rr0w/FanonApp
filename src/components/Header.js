...
import Feather from 'react-native-vector-icons/Feather'; // Using react-native-vector-icons/Feather
...
const AppHeader = ({
  ...
  headerBg = "white",
  iconColor = 'black',
  titleAlight = 'center', // Default alignment for title
  optionalBadge
}) => {
  ...
  return (
    <Surface style={[styles.header, style, { backgroundColor: headerBg }]}>
      {back && (
        <TouchableOpacity style={styles.view} onPress={onPressBack}>
